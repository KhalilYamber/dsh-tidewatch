 ...
 *   deepseek-v4-flash-vision-exp 仍可调用，均路由到 V4.1 Flash 并按新价
 *   计费（见 MODEL_ALIASES）。deepseek-v4-pro 价格不变。
 *
...
export const DEFAULT_PRICE_TABLE = {
  models: {
    'deepseek-flash': {
      ...
      // 沿用旧 V4 Flash 峰谷时代前的基础价（2026-09-10 前历史正确性）。
...
/**
 * 模型别名：旧模型名 → 现役真实模型 key。
 * V4.1 Flash（2026-09-10 上线）更名后，旧名 deepseek-v4-flash /
 * deepseek-v4-flash-vision-exp 仍可调用，路由到 V4.1 Flash 并按新价计费。
 */
