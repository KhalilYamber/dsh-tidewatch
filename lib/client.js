 ...
 * 峰谷窗口/价格表常量与 lib/pricing.js 保持同步（官方 2026-09-10 V4.1-Flash 定价）。
 */
...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    // 展示价 = 官方 2026-09-10 起生效的 V4.1-Flash 新价；Pro 在 09-14 前仍显示 Pro 价。
          ...
          costOpen ? el('div', { className: 'tw-models' },
            Object.entries(usage?.byModel ?? {}).length === 0
              ...
              : Object.entries(usage.byModel)
                  ...
                  .map(([id, bucket]) => {
                    const price = DISPLAY_PRICES[priceEntryForModel(id)]
