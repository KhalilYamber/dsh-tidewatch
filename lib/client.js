...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const FIXED_FX = 6.67
    /** V4 Pro 退休时刻（2026-09-14 04:00 UTC = 北京 12:00）：此日起 pro 按 Flash 价展示。 */
    const V4_PRO_RETIRE_AT = Date.parse('2026-09-14T04:00:00Z')
    ...
    /** 模型名归一化匹配（与 lib/pricing.js 一致；旧名经别名表映射，pro 退休后路由 Flash 价）。 */
    function priceEntryForModel(model, atMs) {
      ...
      // V4 Pro 退休路由：2026-09-14 04:00 UTC 起按 Flash 价展示（与 pricing.js 对称）。
